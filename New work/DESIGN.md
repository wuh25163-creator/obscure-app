...
- **Accent Yellow (UPDATED TO `secondary_color_hex` `#ff3f3f`):** High-energy highlight for CTAs and active states.
...
- **Cards:** Thick black borders, **moderate roundedness**. Content-dense.
- **Inputs:** Thick bottom border only. **moderate roundedness.**
